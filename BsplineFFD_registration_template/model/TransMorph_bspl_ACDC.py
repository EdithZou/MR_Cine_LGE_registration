...
class CubicBSplineNet(nn.Module):
    ...
    def forward(self, src, tar, mode):
        ...
        if mode == 'train':
            ...
            scaled_disp_t2i = scaled_disp_t2i.reshape(self.n, 2, self.ndim, self.bspl_length, self.bspl_length)
            disp_t2i = disp_t2i.reshape(self.n, 2, self.ndim, self.bspl_length, self.bspl_length)
            ...
            scaled_template = torch.zeros([self.n, 1, 32, 32], dtype=torch.float32)
            ...
            disp_t2i = disp_t2i.reshape(1, 2, self.ndim, self.bspl_length, self.bspl_length)
